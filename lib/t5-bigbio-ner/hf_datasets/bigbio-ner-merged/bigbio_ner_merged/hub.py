...
def get_bigbio_datasets():
    """
    Fetch the list of all bigbio datasets

    Returns:
        [str]: List of bigbio dataset names
    """
...
def get_ner_bigbio_datasets():
    """
    Fetch the list of all bigbio datasets that contain "NAMED_ENTITY_RECOGNITION"
    in their README.md file

    Returns:
        [str]: List of bigbio dataset names that contain "NAMED_ENTITY_RECOGNITION"
        in their README.md file
    """
