...
class E3CXlmDataModule(E3CDataModule):
    """This dataset is the whole languages from layer 2 as train set. The validation is monolingual.
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        train_llm_set = datasets.concatenate_datasets(
            [
                e3c_llm_dataset["en_layer2"],
                e3c_llm_dataset["fr_layer2"],
                e3c_llm_dataset["es_layer2"],
                e3c_llm_dataset["eu_layer2"],
                e3c_llm_dataset["it_layer2"],
            ],
        )
        train_set = datasets.concatenate_datasets(
            [
                e3c_dataset["en.layer2"],
                e3c_dataset["fr.layer2"],
                e3c_dataset["es.layer2"],
                e3c_dataset["eu.layer2"],
                e3c_dataset["it.layer2"],
            ],
        )
        ...
        e3c_train_dataset = Dataset.from_dict(train_set[data_train_ids])
        e3c_llm_train_dataset = Dataset.from_dict(train_llm_set[data_train_ids])
