...
gen_dataset=clinical-dream-team/gen-style-transfer/run-3f6pj79u-gen_dataset:v0 \
test_dataset=clinical-dream-team/gen-style-transfer/run-3f6pj79u-test_dataset:v0 \
sft_ratio=0.06 \
gen_ratio=0.7 \
