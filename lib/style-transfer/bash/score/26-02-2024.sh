...
gen_dataset=clinical-dream-team/gen-style-transfer/run-pkyinso0-gen_dataset:v0 \
test_dataset=clinical-dream-team/gen-style-transfer/run-pkyinso0-test_dataset:v0 \
sft_ratio=0.06 \
gen_ratio=0.7 \
