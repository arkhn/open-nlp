...
from pytorch_lightning import Callback, LightningDataModule, LightningModule, Trainer  # noqa: E402
...
def train(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    model: LightningModule = hydra.utils.instantiate(
        cfg.model,
        labels2id=datamodule.labels2id,
        id2labels=datamodule.id2labels,
        weights=datamodule.weights,
    )
